...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        ...
        {
            "name": "CloudAssistantESL" + "_" + process.env.ENV,
            ...
            "fulfillmentLambda": {
                "region": "us-east-1",
                "accountId": "475852407060",
                "lambdaArn": "arn:aws:lambda:us-east-1:475852407060:function:test1",
                "lambdaName": "test1",
            },
            "fulfillmentActivity": {
                "type": "CodeHook",
                "codeHook": {
                    "messageVersion": "1.0",
                    "uri": "arn:aws:lambda:us-east-1:475852407060:function:test1"
                }
            },
    ...
    let botParams = {
        ...
        "intents": [
            ...
            {
                "intentName": "CloudAssistantESL" + "_" + process.env.ENV,
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "e778ea5c",
